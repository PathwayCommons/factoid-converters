...
public class CustomizableModel {
	...
	// Probably no need for these. However, let them stay commented out for now 
...
//		return model.getOrCreatePhysicalEntity(c, name, entityRef, modificationTypes, modificationNotTypes, inComplex, componentModels, cellularLocation);
//	}
//	
